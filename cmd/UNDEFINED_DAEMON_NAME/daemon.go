...
func setupNetwork(cfg ExtendedDaemonConfig) (setupNetworkConfig, error) {
	...
	case config.NetworkNameTest:
		return setupNetworkConfig{}, errors.New("testnet net is disabled for this chain, it is not ready for a public testnet") // TODO: enable and configure
